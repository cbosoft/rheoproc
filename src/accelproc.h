...
// peakdet.c
void peakdet(double* signal, size_t len, double threshold, double **peaks, size_t **peak_indices, size_t *npeaks, int mode);
#define PEAKDET_MODE_POSITIVE 0
#define PEAKDET_MODE_NEGATIVE 1
#define PEAKDET_MODE_BOTH 2
